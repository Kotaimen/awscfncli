...
Commands:
  ...
  describe                    Print status, parameters, outputs, stack...
  set_termination_protection  Update the termination protection...
...
Commands:
  costs     Estimate cost of the stack.
  package   Package template specified in the stack...
